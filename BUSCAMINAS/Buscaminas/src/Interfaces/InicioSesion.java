...
public class InicioSesion extends javax.swing.JFrame 
{
    ...
    void getJugador(String name,String psw)
    {
        ...
        {
            if (main.listaJ.get(i).getNombre().equals(name) && main.listaJ.get(i).getContraseña().equals(psw))
            {
                Interfaces.Jugador jgdr = new Interfaces.Jugador(i);
                jgdr.setVisible(true);
                this.setVisible(false);
                break;
            }
            else if (i  == main.listaJ.size() - 1)
            {
                JOptionPane.showMessageDialog(rootPane, "INCORRECTO, INTÉNTELO DE NUEVO", "ERROR", 2);
            }
        }
    }    
...
void getAdmin(String name,String psw)
    {
        ...
        if (name.equals("Carlos") && psw.equals("POO"))
            {
